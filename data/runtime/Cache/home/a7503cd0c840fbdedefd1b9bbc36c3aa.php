...
//]]></script><script charset="utf-8" type="text/javascript" src="../Style/js/dialog.js" id="dialog_js"></script><link href="../Style/dialog.css" rel="stylesheet" type="text/css"><script charset="utf-8" type="text/javascript" src="../Style/js/jquery.ui.js" ></script><script charset="utf-8" type="text/javascript" src="../Style/js/jquery.validate.js" ></script><script charset="utf-8" type="text/javascript" src="../Style/js/mlselection.js" ></script><script type="text/javascript" language="javascript" src='../Style/js/dizhi2.js'></script><script type="text/javascript" language="javascript" src='../Style/js/diqu2.js'></script></head><body><div id="head"><img height="50" src="../Style/images/store_logo.jpg"></div><div id="nav"><ul class="navlist"><li id="n_0"><span ></span><ul class="submenu"><?php if(is_array($index_cate_list)): $i = 0; $__LIST__ = $index_cate_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('book/cate',array('cid'=>$vo['id']));?>" class="none_ico"><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></li><li class="r active" id="n_1"><a href="<?php echo U('Index/index');?>"><span></span></a></li><li class="r" id="n_2"><a href="<?php echo U('User/index');?>"><span></span></a></li><li class="r" id="n_3"><a href="<?php echo U('Shopcart/index');?>"><span></span></a><i></i></li></ul><script type="text/javascript">    	$(".navlist > li#n_0").click(function(){
    ...
    </script></div><div id="content"><h4 class="add_title"><a class="enter" href="<?php echo U('user/address');?>">管理收货地址</a></h4><div class="order_address_list"><h4 class="add_title">收货人地址</h4><script type="text/javascript"><script type="text/javascript">       $(function(){
       	$('#order_form').validate({
     ...
     <?php }else{ ?><h4 class="add_title">选择配送方式</h4><div class="fashion_list"><?php if(is_array($freearr)): $k = 0; $__LIST__ = $freearr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><ul class="receive_add" shipping_id="<?php echo ($vo["value"]); ?>"><li class="radio"><input id="<?php echo ($vo["price"]); ?>" <?php if($k == 1): ?>checked="checked"<?php endif; ?>  name="shipping_id" value="<?php echo ($vo["value"]); ?>" type="radio"></li><li class="fashion"><?php switch($vo["value"]): case "1": ?>平邮<?php break; case "2": ?>快递<?php break; default: ?>EMS<?php endswitch;?></li><li class="pay">配送费用:&nbsp;<span class="money" ectype="shipping_fee">¥<?php echo ($vo["price"]); ?></span></li><li class="explain"></li><input type="hidden" id="price_<?php echo ($vo["value"]); ?>" value="<?php echo ($vo["price"]); ?>" ></ul><?php endforeach; endif; else: echo "" ;endif; ?><!--   <ul class="receive_add" shipping_id="2"><li class="radio"><input checked="checked" name="shipping_id" value="2" type="radio"></li><li class="fashion">快递</li><li class="pay">配送费用:&nbsp;<span class="money" ectype="shipping_fee">¥0.01</span></li><li class="explain"></li></ul><ul class="receive_add" shipping_id="3"><li class="radio"><input checked="checked" name="shipping_id" value="3" type="radio"></li><li class="fashion">EMS</li><li class="pay">配送费用:&nbsp;<span class="money" ectype="shipping_fee">¥0.01</span></li><li class="explain"></li></ul>--></div><?php } ?></div><div class="message_box"><script type="text/javascript">        function postscript_activation(tt){
        ...
        </script><span class="add_title">给卖家的附言</span><div class="message"><textarea id="postscript"  onclick="postscript_activation(this);">选填，可以告诉卖家您对商品的特殊需求，如颜色、尺码等</textarea></div></div></form><div class="make_sure"><p class="order_amount">订单总价:<strong class="fontsize3" id="order_amount">¥<font id='order_amount2'></strong><input class="btn1" onclick="$(this).parent('p').next().toggle();$('#coupon_sn').val('');" style="display:none" type="button"></p><div><a onclick="ordertj();" class="btn enter">下单完成并支付</a><a href="<?php echo U('Shopcart/index');?>" class="back">返回购物车</a></div></div><input type="hidden" id="summoney" value="<?php echo ($sumPrice); ?>" /></div><div id="footer"><p class="foot_nav"><a href="<?php echo U('Index/index');?>">商城首页</a> | <a href="<?php echo U('User/index');?>">会员中心</a> | <a href="<?php echo U('Shopcart/index');?>">购物车</a> | <a href="<?php echo U('aboutus/index', array('id'=>2));?>">品牌介绍</a></p><div style="height:40px; background:#fff; padding:0; overflow:hidden;">        &copy;Copyright 2013-2014 <a href="__ROOT__/" class="tdu clr6" target="_blank"><?php echo C('pin_site_name');?></a> 版权所有 
