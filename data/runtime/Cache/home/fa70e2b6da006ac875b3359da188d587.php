...
//]]></script><script charset="utf-8" type="text/javascript" src="../Style/js/jquery.validate.js"></script></head><body><div id="head"><img height="50" src="../Style/images/store_logo.jpg"></div><div id="nav"><ul class="navlist"><li id="n_0"><span ></span><ul class="submenu"><?php if(is_array($index_cate_list)): $i = 0; $__LIST__ = $index_cate_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('book/cate',array('cid'=>$vo['id']));?>" class="none_ico"><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></li><li class="r active" id="n_1"><a href="<?php echo U('Index/index');?>"><span></span></a></li><li class="r" id="n_2"><a href="<?php echo U('User/index');?>"><span></span></a></li><li class="r" id="n_3"><a href="<?php echo U('Shopcart/index');?>"><span></span></a><i></i></li></ul><script type="text/javascript">    	$(".navlist > li#n_0").click(function(){
    ...
    </script></div><script type="text/javascript">//注册表单验证
$(function(){
...
</script><div id="content"><form name="" id="register_form" method="post" action="<?php echo U('User/register');?>"><input id="user_name" name="user_name" placeholder="用户名" class="text width10" type="text"><label id="checking_user" class="checking"></label><input id="password" name="password" placeholder="密&nbsp;&nbsp;&nbsp;码" class="text width10" type="password"><input name="password_confirm" placeholder="确认密码" class="text width10" type="password"><input name="email" placeholder="电子邮箱" class="text width10" type="text"><input name="Submit" value="立即注册" class="login_btn" title="立即注册" type="submit"><input name="ret_url" value=" " type="hidden"></form></div><div id="footer"><p class="foot_nav"><a href="<?php echo U('Index/index');?>">商城首页</a> | <a href="<?php echo U('User/index');?>">会员中心</a> | <a href="<?php echo U('Shopcart/index');?>">购物车</a> | <a href="<?php echo U('aboutus/index', array('id'=>2));?>">品牌介绍</a></p><div style="height:40px; background:#fff; padding:0; overflow:hidden;">        &copy;Copyright 2013-2014 <a href="__ROOT__/" class="tdu clr6" target="_blank"><?php echo C('pin_site_name');?></a> 版权所有 
